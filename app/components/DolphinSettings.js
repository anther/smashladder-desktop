...
export default class DolphinSettings extends Component {
  ...
  constructor(props) {
    ...
    this.onUpdateSearchSubdirectories = this.updateSearchSubdirectoriesChange.bind(
      this
    );
    this.onUpdateAllowDolphinAnalytics = this.updateAllowDolphinAnalytics.bind(
      this
    );
    this.state = {
